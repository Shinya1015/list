...
const lowPitchSongs = [
    ...
    "1/6/ぼーかりおどP",           // (通常演唱音區不會太高)
    "Ref:rain/Aimer",            // (Aimer 低音部分)
    "僕が死のうと思ったのは/amazarashi", // (念白較多，情感表達為主)
    "しおり/Aqua Timez",          // (抒情)
    ...
    "ミカヅキ/さユり",           // (有較低部分)
    "ボクノート/スキマスイッチ",    // (抒情)
    "美しい鰭/スピッツ",         // (Spitz 歌曲通常音域友好)
    "風になる/つじあやの",       // (Ukulele 曲，非常平緩)
    "ハロ/ハワユ/ナノウ",        // (常見翻唱，相對不高)
    "悪魔の子/ヒグチアイ",       // (氛圍感，相對中低)
    "またあした/ふわりP",        // (溫馨平緩)
    "サウダージ/ポルノグラフィティ", // (雖然有激情但音域相對可控)
    "栄光の架橋/ゆず",           // (開頭和主歌相對較低)
